class robot:
    def __init__(self):
        ...
        self.opNames = ["IDLE", "MOW", "CHARGE", "ERROR", 
                      "Go TO DOCK","INC_01","INC_02","INC_03","INC_04","INC_05","INC_06"]

        self.gpsSolution = ["INVALID", "FLOAT", "FIX", "INC_03","INC_04","INC_05","INC_06"]
