...
#define MOWER_SIZE            80         // mower / chassis size / length in cm
...
#define MOTOR_TOO_LOW_CURRENT 0.005   // mowing motor too low current (amps)
...
#define ALLOW_ROUTE_OUTSIDE_PERI_METER 0.5   // max. distance (m) to allow routing from outside perimeter 
...
// warning return to this value after a reset
